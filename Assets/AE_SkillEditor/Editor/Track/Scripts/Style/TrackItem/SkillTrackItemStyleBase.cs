...
namespace ARPG_AE_JOKER.SkillEditor
{
    ...
    public class SimpleItemStyle : SkillTrackItemStyleBase
    {
        ...
        {
            TrackItemAssetPAth = TrackItemAssetPAth == null ? "Assets/AE_SkillEditor/Editor/Track/Assets/TrackItem/AnimationTrackItem.uxml" : TrackItemAssetPAth;
    ...
    public class EventItemStyle : SimpleItemStyle
    {
        ...
        public override void Init(SkillTrackStyleBase ParentTrackStyle, float width, float position, string name, string TrackItemAssetPAth = null)
        {
            base.Init(ParentTrackStyle, width, position, name, "Assets/AE_SkillEditor/Editor/Track/Assets/TrackItem/EvenItemStyle.uxml");
