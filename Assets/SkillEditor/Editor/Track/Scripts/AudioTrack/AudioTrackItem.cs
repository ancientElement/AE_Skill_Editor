...
namespace ARPG_AE_JOKER.SkillEditor
{
    public class AudioTrackItem : MultLineTrackItem<SkillAudioEvent>
    {
        ...
        public override void Init(ChildTrackBase<SkillAudioEvent> m_ParentTrack, SkillTrackStyleBase m_parentTrackStyle, SkillFrameEventBase m_ItemData, int frameIndex, float frameUniWidth)
        {
