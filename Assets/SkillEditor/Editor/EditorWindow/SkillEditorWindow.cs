...
namespace ARPG_AE_JOKER.SkillEditor
{
    public  class SkillEditorWindow : EditorWindow
    {
        ...
        private const string stylePath = "Assets/SkillEditor/Editor/Track/Assets/Uss/Extend.uss";
        private const string AssetPath = "Assets/SkillEditor/Editor/EditorWindow/SkillEiditorWindow.uxml";
