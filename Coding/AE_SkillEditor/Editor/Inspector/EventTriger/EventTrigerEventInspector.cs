...
namespace ARPG_AE_JOKER.SkillEditor
{
    ...
    public class EventTrigerEventDataInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorGUILayout.DropdownButton(new GUIContent(helper.skillFrameEventBase.eventName), FocusType.Keyboard))
            {
                ...
                foreach (var item in list)
                {
                    ...
                    //设置内容、勾选条件和点击回调
                    genericMenu.AddItem(new GUIContent(name), item == helper.skillFrameEventBase.eventName, () =>
                    {
                        helper.skillFrameEventBase.eventName = item;
                        helper.OnValidate();
                    });
                }
                //显示菜单
