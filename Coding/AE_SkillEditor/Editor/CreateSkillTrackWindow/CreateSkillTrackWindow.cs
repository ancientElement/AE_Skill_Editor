...
public class CreateSkillTrackWindow : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        // Import UXML
        var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/AE_SkillEditor/Editor/CreateSkillTrackWindow/CreateSkillTrackWindow.uxml");
    ...
    //模板地址
    public static string MultiLineTrackPath = "Assets/AE_SkillEditor/Editor/Track/Assets/MobaTrack/TestMultiTrack.txt";

    public static string MultiLineTrackEventPath = "Assets/AE_SkillEditor/Editor/Track/Assets/MobaTrack/TestMultiLineFrameEven.txt";
    public static string SingleLineTrackPath = "Assets/AE_SkillEditor/Editor/Track/Assets/MobaTrack/TestSingLineTrack.txt";
    public static string SingleLineTrackEventPath = "Assets/AE_SkillEditor/Editor/Track/Assets/MobaTrack/TestSinglineEvent.txt";
    public static string InspecterHelperPath = "Assets/AE_SkillEditor/Editor/Track/Assets/MobaTrack/TestEventInspectorHelper.txt";
    public static string InspecterPath = "Assets/AE_SkillEditor/Editor/Track/Assets/MobaTrack/TestEventInspector.txt";
